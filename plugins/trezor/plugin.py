...
from electrum_cesc.account import BIP32_Account
from electrum_cesc.bitcoin import (bc_address_to_hash_160, xpub_from_pubkey,
...
from electrum_cesc.transaction import (deserialize, is_extended_pubkey,
...
class TrezorCompatibleWallet(BIP44_HW_Wallet):
    ...
    def sign_message(self, address, message, password):
        ...
        address_path = self.address_id(address)
        address_n = client.expand_path(address_path)
        msg_sig = client.sign_message('Cryptoescudo', address_n, message)
...
class TrezorCompatiblePlugin(HW_PluginBase):
    ...
    def sign_transaction(self, wallet, tx, prev_tx, xpub_path):
        ...
        signed_tx = client.sign_tx('Cryptoescudo', inputs, outputs)[1]
    ...
    def show_address(self, wallet, address):
        ...
        address_n = client.expand_path(address_path)
        client.get_address('Cryptoescudo', address_n, True)
