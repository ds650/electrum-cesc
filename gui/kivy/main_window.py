...
from electrum_cesc.util import profiler, InvalidPassword
from electrum_cesc.plugins import run_hook
from electrum_cesc.util import format_satoshis, format_satoshis_plain
...
Factory.register('InstallWizard',
                 module='electrum_cesc_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='electrum_cesc_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='electrum_cesc_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='electrum_cesc_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrum_cesc_gui.kivy.uix.screens')
...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'CESC')
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_cesc.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_cesc_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_cesc_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_cesc_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_cesc_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-cesc.png"
