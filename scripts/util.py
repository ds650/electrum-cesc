import select, time, electrum_cesc as electrum, Queue
from electrum_cesc import Connection, Interface, SimpleConfig
from electrum_cesc.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    server = 'electrum-cesc.bysh.me:50002:s'
